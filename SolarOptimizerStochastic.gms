...
;
FindCost.. Cost =e= sum((y), probability(y)*sum((m,d,t), (Grid(y,m,d,t)*Tariff(y,m,d,t) - (SolarExport(y,m,d,t)*BuyBackRate))))
                     + (SolarInstalled)*(PanelCost*TaxDiscount) +BatteryCost*BatterykW
                     + Sum((y,m,d,t), SolarReject(y,m,d,t)*0.001);

GridUse(y,m,d,t).. (Solarinhouse(y,m,d,t))+Grid(y,m,d,t)+BatteryOut(y,m,d,t)*BatteryEfficiency =e= Data(m,d,t,"DemandTemple2018");
...
TotalDemandkWh(y) = Sum((m,d,t), Data(m,d,t,"DemandTemple2018"));
